<template>
  <div class="app__box">
    <label for="box-title" class="box-label app__label">Totem</label>
    <v-select @input="displaySelect" v-model="selected" class="app__select" :options="selectList"></v-select>
    <div class="column">
      <div class="half">
        <p class="app__label">Adicione setor ao totem</p>
